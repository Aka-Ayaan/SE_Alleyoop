...
export function ResendVerificationScreen({ onBackToLogin }) {
  ...
  const handleResendVerification = async () => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        setSuccess(data.message || 'If an unverified account exists for this email, a verification link has been sent.');
      }
    } catch (e) {
        ...
        >
          ...
          >
            <View style={styles.header}>
              <Text style={styles.title}>Missed the email?</Text>
              <Text style={styles.subtitle}>Enter the same email used at signup to get a fresh verification link.</Text>
            </View>
            ...
            <View style={styles.form}>
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.85}
              >
                {loading ? <ActivityIndicator color="#fff" /> : <Text style={styles.primaryBtnText}>RESEND VERIFICATION</Text>}
              </TouchableOpacity>
